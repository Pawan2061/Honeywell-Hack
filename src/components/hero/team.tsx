...
const people: People[] = [
  ...
  {
    name: 'Pawan Pandey',
    role: '2nd year - CSE DS',
    imageUrl: 'https://avatars.githubusercontent.com/u/124860988?v=4',
    link: 'https://github.com/pawan2061',
  },
  {
    name: 'Rahul Yadav',
    role: '2nd year - CSE',
    imageUrl: 'https://avatars.githubusercontent.com/u/121729670?v=4',
    link: 'https://github.com/ryrahul',
  },
  {
    name: 'Dipendra Bhatta',
    role: '2nd year - CSE SE',
